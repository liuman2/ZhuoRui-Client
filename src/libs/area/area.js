//========== area.js =========//
window.AREA_Module = window['AREA_Module'] || {};

window.AREA_Module.area = (function($) {
  var provinceList = [/*{
    name: '请选择省份',
    cityList: [{
      name: '请选择城市',
    ...
    cityList: [{
      name: '成都市',
      areaList: ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江县', '金堂县', '双流县', '郫县', '大邑县', '蒲江县', '新津县', '都江堰市', '彭州市', '邛崃市', '崇州市']
    }, {
      name: '自贡市',
      ...
      name: '绵阳市',
      areaList: ['涪城区', '游仙区', '三台县', '盐亭县', '安县', '梓潼县', '北川羌族自治县', '平武县', '江油市']
    }, {
      name: '广元市',
      ...
      name: '宜宾市',
      areaList: ['翠屏区', '宜宾县', '南溪县', '江安县', '长宁县', '高县', '珙县', '筠连县', '兴文县', '屏山县']
    }, {
      name: '广安市',
      areaList: ['广安区', '岳池县', '武胜县', '邻水县', '华莹市']
    }, {
      name: '达州市',
      areaList: ['通川区', '达县', '宣汉县', '开江县', '大竹县', '渠县', '万源市']
    }, {
      name: '雅安市',
    ...
    cityList: [{
      ...
      name: '那曲地区',
      areaList: ['那曲县', '嘉黎县', '比如县', '聂荣县', '安多县', '申扎县', '索县', '班戈县', '巴青县', '尼玛县']
    }, {
      name: '阿里地区',
    ...
    cityList: [{
      ...
      name: '开封市',
      areaList: ['龙亭区', '顺河回族区', '鼓楼区', '南关区', '郊区', '杞县', '通许县', '尉氏县', '开封县', '兰考县']
    }, {
      name: '洛阳市',
    ...
    cityList: [{
      ...
      name: '十堰市',
      areaList: ['茅箭区', '张湾区', '郧县', '郧西县', '竹山县', '竹溪县', '房县', '丹江口市']
    }, {
      name: '宜昌市',
    ...
    cityList: [{
      ...
      name: '永州市',
      areaList: ['芝山区', '冷水滩区', '祁阳县', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县']
    }, {
      name: '怀化市',
    ...
    cityList: [{
      ...
      name: '梅州市',
      areaList: ['梅江区', '梅县', '大埔县', '丰顺县', '五华县', '平远县', '蕉岭县', '兴宁市']
    }, {
      name: '汕尾市',
    ...
    cityList: [{
      name: '南宁市',
      areaList: ['兴宁区', '青秀区', '江南区', '西乡塘区', '良庆区', '邕宁区', '武鸣县', '隆安县', '马山县', '上林县', '宾阳县', '横县']
    }, {
      name: '柳州市',
      ...
      name: '梧州市',
      areaList: ['万秀区', '蝶山区', '长洲区', '苍梧县', '藤县', '蒙山县', '岑溪市']
    }, {
      name: '北海市',
    ...
    cityList: [{
      name: '西安市',
      areaList: ['新城区', '碑林区', '莲湖区', '灞桥区', '未央区', '雁塔区', '阎良区', '临潼区', '长安区', '蓝田县', '周至县', '户县', '高陵县']
    }, {
      name: '铜川市',
      ...
      name: '延安市',
      areaList: ['宝塔区', '延长县', '延川县', '子长县', '安塞县', '志丹县', '吴旗县', '甘泉县', '富县', '洛川县', '宜川县', '黄龙县', '黄陵县']
    }, {
      name: '汉中市',
    ...
    cityList: [{
      name: '石家庄市',
      areaList: ['长安区', '桥东区', '桥西区', '新华区', '井陉矿区', '裕华区', '井陉县', '正定县', '栾城县', '行唐县', '灵寿县', '高邑县', '深泽县', '赞皇县', '无极县', '平山县', '元氏县', '赵县', '辛集市', '藁城市', '晋州市', '新乐市', '鹿泉市']
    }, {
      name: '唐山市',
      areaList: ['路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '滦县', '滦南县', '乐亭县', '迁西县', '玉田县', '唐海县', '遵化市', '迁安市']
    }, {
      name: '秦皇岛市',
      ...
      name: '衡水市',
      areaList: ['桃城区', '枣强县', '武邑县', '武强县', '饶阳县', '安平县', '故城县', '景县', '阜城县', '冀州市', '深州市']
    }]
  }, {
    name: '山西省',
    cityList: [{
    ...
    cityList: [{
      ...
      name: '徐州市',
      areaList: ['鼓楼区', '云龙区', '九里区', '贾汪区', '泉山区', '丰县', '沛县', '铜山县', '睢宁县', '新沂市', '邳州市']
    }, {
      name: '常州市',
      ...
      name: '扬州市',
      areaList: ['广陵区', '邗江区', '郊区', '宝应县', '仪征市', '高邮市', '江都市']
    }, {
      name: '镇江市',
    ...
    cityList: [{
      ...
      name: '安庆市',
      areaList: ['迎江区', '大观区', '郊区', '怀宁县', '枞阳县', '潜山县', '太湖县', '宿松县', '望江县', '岳西县', '桐城市']
    }, {
      name: '黄山市',
      ...
      name: '巢湖市',
      areaList: ['居巢区', '庐江县', '无为县', '含山县', '和县']
    }, {
      name: '六安市',
      areaList: ['金安区', '裕安区', '寿县', '霍邱县', '舒城县', '金寨县', '霍山县']
    }, {
      name: '亳州市',
    ...
    cityList: [{
      ...
      name: '赣州市',
      areaList: ['章贡区', '赣县', '信丰县', '大余县', '上犹县', '崇义县', '安远县', '龙南县', '定南县', '全南县', '宁都县', '于都县', '兴国县', '会昌县', '寻乌县', '石城县', '瑞金市', '南康市']
    }, {
      name: '吉安市',
    ...
    cityList: [{
      ...
      name: '临沂市',
      areaList: ['兰山区', '罗庄区', '河东区', '沂南县', '郯城县', '沂水县', '苍山县', '费县', '平邑县', '莒南县', '蒙阴县', '临沭县']
    }, {
      name: '德州市',
      areaList: ['德城区', '陵县', '宁津县', '庆云县', '临邑县', '齐河县', '平原县', '夏津县', '武城县', '乐陵市', '禹城市']
    }, {
      name: '聊城市',
    ...
    cityList: [{
      ...
      name: '锦州市',
      areaList: ['古塔区', '凌河区', '太和区', '黑山县', '义县', '凌海市', '北宁市']
    }, {
      name: '营口市',
    ...
    cityList: [{
      ...
      name: '佳木斯市',
      areaList: ['永红区', '向阳区', '前进区', '东风区', '郊区', '桦南县', '桦川县', '汤原县', '抚远县', '同江市', '富锦市']
    }, {
      name: '七台河市',
    ...
    cityList: [{
      ...
      name: '三亚市',
      areaList: ['海棠湾镇', '田独镇', '凤凰镇', '崖城镇', '天涯镇', '育才镇']
    }, {
      name: '五指山市',
      areaList: []
    }, {
  ...
  var addressInit = function(_cmbAddress, defaultProvince, defaultCity, defaultArea, $scope) {
    ...
    // 查到省份
    if (valProvince) {
      cmbProvince.val(valProvince).trigger('change');
    } else {
      return false;
    }
    ...
    // 查到县
    var valArea = areaIndex(defaultArea);
    if (valArea) {
      cmbCounty.val(valArea).trigger('change');
    } else {
      return false;
    }
  }

  var provinceIndex = function(defaultProvince) {
    var index = '';
    // $.each(provinceList, function(key, item) {
    //   if (item.name == defaultProvince) {
    //     index = String(key);
    //     return cityList = item.cityList;
    //   }
    // });
    for (var i = 0, max = provinceList.length; i < max; i++) {
      var province = provinceList[i];
      if (province.name == defaultProvince) {
        index = i;
  ...
  // 获取市序号
  var cityIndex = function(defaultCity) {
    var index = '';

    $.each(cityList, function(key, item) {
      if (item.name == defaultCity) {
        index = String(key);
        return areaList = item.areaList;
      }
    });
